    ...
    render() {
        return (
            ...
            <div>
                ...
                <p>The Upper Monroe Neighborhood Association (Home) is a not-for-profit advocacy group representing the 3,300 residents and property owners in the Upper Monroe Neighborhood.</p>
                ...
                <p>We’ll keep you continually informed of happenings on our Community News page.  Subscribe to Home for the latest buzz on area happenings. And, if you’ve got something to say about the Upper Monroe Neighborhood, say it on <a href="https://nextdoor.com/login/?next=/news_feed/" target="_blank">Nextdoor Upper Monroe</a>, or Upper Monroe Neighborhood’s <a href="https://www.facebook.com/uppermonroe" target="_blank">Facebook</a>. Also, our neighborhood includes <a href="http://www.uppermonroeavenue.org/washington-grove/" target="_blank">Washington Grove Park</a>, a beautiful Old Growth forest wonderfully maintained.</p>
                ...
                <ul>
                    <li>Home dues are collected annually by Calendar Year – January 1st. to December 31st.</li>
                    <li>Please note that Home does not solicit memberships door-to-door, but only through the newsletter or by mail (Please download <span id="print_form" onClick={() => this.openMembershipForm() }>Home Membership Form</span>, print and send) – and now online.</li>
                    <li>Questions about membership? Contact us here, and thank you for your support!</li>
                    <li>Home <span id="print_form" onClick={() => this.openByLaws() }>ByLaws</span></li>
                </ul>

                <p>Do you have an hour or so a month for the neighborhood?</p>

                <p>A strong neighborhood association is important for a neighborhood’s vitality.  We are a voice for the residents of Upper Monroe, a liaison to the City.  Our aim to build connections and community, while enhancing the neighborhood for all. We keep our eye on planning, zoning and general neighborhood issues as they arise. AND we need your participation.  Home meets on the first Tuesday of the Month, from 7:00 – 8:30.  Home is SEEKING participants, board members, and board officers.  Many of our board members have served for years; it’s time for a few new hands to keep the organization vibrant. We invite you to join us, no commitment required!
                </p>
            </div>
        )
    }
